    ...
    <>
      <div className="flex flex-col relative " data-aos="fade-down">
       ...
       <div className="absolute inset-0 inset-x-0 m-16 mr-2 flex items-stretch justify-end space-x-2 ">
          ...
          <button className="py-2 px-4 bg-white border-2 border-black font-semibold rounded-lg shadow-md hover:bg-white focus:outline-none focus:ring-2  focus:ring-2 focus:bg-white focus:ring-opacity-75 ring-transparent">
           <img src="/img/github.png" alt="See on Github" className="h-5 " />
           </button>
          </a>
          <a href={vercel} className="relative inset-0" >
          <button className="py-2 px-4 bg-white border-2 border-black  font-semibold rounded-lg shadow-md hover:bg-white focus:outline-none focus:ring-2 focus:bg-white focus:ring-opacity-75 ring-transparent">
