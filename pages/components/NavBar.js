...
function NavBar() {
  return (
    <nav className="flex bg-red-100 sticky top-0 z-50  md:bg-contain w-screen p-4 text-1xl md:text-1xl  items-center justify-center md:space-x-28 space-x-6 md:text-center ... ">
